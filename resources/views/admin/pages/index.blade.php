        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">pages list</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('admin.dashboard')}}"
                               class="text-muted text-hover-primary">dashboard home</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
...
@section('scripts')
    ...
    {{--<script>
        CKEDITOR.replace('update_editor_en', {
            height: 300,
        ...
        <script>
            ...
            var KTUsersUpdateDetails = function () {
                ...
                var populateForm = (response) => {
                    ...
                    // Destroy existing CKEditor instance to avoid duplication
                    if (CKEDITOR.instances['update_editor_en']) {
                        CKEDITOR.instances['update_editor_en'].destroy(true);
                    }

                    // Reinitialize CKEditor and bind validation re-check
                    CKEDITOR.replace('update_editor_en', {
                        height: 300,
                        filebrowserUploadUrl: '{{ route('admin.ckeditor.upload') }}?_token={{ csrf_token() }}',
                        filebrowserUploadMethod: 'form'
                    ...
                    CKEDITOR.instances['update_editor_en'].on('change', function () {
                        validator.revalidateField('value'); // Force revalidate
                    });
